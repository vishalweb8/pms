...
class SendLeaveCompensationRequestEmail implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        Mail::send('emails.leave-compensation-emails.leave_compensation_request', ['leaveDetails' => $this->leaveDetails, 'applied_person' => $applied_person, 'action_url' => $this->action_url], function ($message) use ($send_to_users, $applied_person) {
            ...
            ->subject('Leave Compensation Request From ' .ucwords($applied_person->full_name));
        });
    }
}
