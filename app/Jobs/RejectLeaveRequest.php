...
class RejectLeaveRequest implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        Mail::send('emails.leave-emails.leave_reject_request', ['leaveDetails' => $leave_details,'leave_comment' => $this->leave_comment], function ($message) use ($leave_details, $cc_users) {
