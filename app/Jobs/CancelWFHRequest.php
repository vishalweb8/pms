...
class CancelWFHRequest implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        Mail::send('emails.wfh-emails.wfh_cancel_request', ['wfhDetails' => $wfh_details,'comments' => $this->wfh_comment], function ($message) use ($wfh_details, $cc_users) {
            ...
            $message->subject('Work From Home Request Cancelled');
        });
    }
}
