...
class RejectLeaveCompensationRequest implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        Mail::send('emails.leave-compensation-emails.leave_compensation_reject_request', ['leaveDetails' => $leave_details,'leave_comment' => $this->leave_comment], function ($message) use ($leave_details, $cc_users) {
            ...
            $message->subject('Leave Compensation Request Rejected');
        });
    }
}
