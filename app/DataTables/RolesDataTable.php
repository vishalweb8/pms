...
class RolesDataTable extends DataTable
{
    ...
    {
        $options = collect([
            ['btn_file_name' => 'edit', 'permission' => 'roles.edit', 'link' => route('roles.edit', $row->id)],
            // ['btn_file_name' => 'delete', 'permission' => 'roles.destroy', 'link' => route('roles.destroy', $row->id)],
            ['btn_file_name' => 'permission', 'permission' => 'permission.list', 'link' => route('roles.permission', $row->id)],
        ]);
