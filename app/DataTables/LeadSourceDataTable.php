...
class LeadSourceDataTable extends DataTable
{
    ...
    {
        $options = collect([
            ['btn_file_name' => 'edit', 'permission' => 'lead-source.edit', 'link' => route('lead-source.edit', $row->id),],
            // ['btn_file_name' => 'delete', 'permission' => 'lead-source.destroy', 'link' => route('lead-source.destroy', $row->id),],
        ]);
