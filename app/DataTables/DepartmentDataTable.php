...
class DepartmentDataTable extends DataTable
{
    ...
    public function applyFilter($query)
    {
        if(request()->order[0]['column'] != null){
            ...
            if(Schema::hasColumn('department',$column_name)){
    ...
    {
        $options = collect([
            ['btn_file_name' => 'edit', 'permission' => 'department.edit', 'link' => route('department.edit', $row->id),],
            // ['btn_file_name' => 'delete', 'permission' => 'department.destroy', 'link' => route('department.destroy', $row->id), 'title' => $row->department],
        ]);
