...
class UserDesignationDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\UserDesignation $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(UserDesignation $model)
    {
        return $model->select();
    }
    ...
    {
        $options = collect([
            ['btn_file_name' => 'edit', 'permission' => 'designation.edit', 'link' => route('designation.edit', $row->id),],
            // ['btn_file_name' => 'delete', 'permission' => 'designation.destroy', 'link' => route('designation.destroy', $row->id),],
        ]);
