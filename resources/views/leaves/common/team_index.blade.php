    ...
    <div class="col-xl-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="d-sm-flex  align-items-center filter-with-search">
                ...
                @if(Helper::hasAnyPermission(['leave.create']) && !isset($teamLeave))
                <a href="{{ route('leave-add-view') }}"
                    class="text-truncate ms-3 btn btn-primary waves-effect waves-light" type="button">Add Leave</a>
                @elseif (Helper::hasAnyPermission(['leaveteam.create']) && isset($teamLeave))
                <a href="{{ route('leave-add-team')}}"
                    class="text-truncate ms-3 btn btn-primary waves-effect waves-light" type="button">Add Leave
                    Requests</a>
                @endif
            </div>
        </div>
