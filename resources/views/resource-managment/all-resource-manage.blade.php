                        ...
                        <thead>
                            <tr>
                                ...
                                <th>
                                    ...
                                    <div class="col-md-3 ">
                                        @include('filters.experience')
                                    </div>
                                    {{-- <div class="col-md-1">
                                        <button class="btn btn-sm btn-secondary cursor-pointer" id="sortByExperience" data-sort="asc" title="Sort by experience"><i class="fa fa-sort" aria-hidden="true"></i> Experience </button>
                                        <span class="d-flex cursor-pointer" id="sortByExperience" data-sort="asc" title="Sort by experience"><i class="fa fa-sort" aria-hidden="true"></i>  Experience </span>
                                    </div> --}}
                                    <div class="col-md-6">
                                    @php
                                        $options = [
                                            ['class' => 'bg-external', 'title' => "Billable"],
                                            ['class' => 'bg-internal', 'title' => "Non-Billable"],
                                            ['class' => 'bg-hold', 'title' => "On-Hold"]
                                        ];
                                    @endphp
                                    @include('common.color-indication', ['alignment_class' => 'float-end', 'options' => $options, 'experience' => true])
                                </div>
                                </div>
                                </th>
                            </tr>
...
@push('scripts')
<script>
    const REMOVE_PROJECT_URL = "{{route('unassign-resource-project')}}";
...
<script type="text/javascript">
    ...
    var AllEmpPage = true;
    var page = 1;
    var siteUrl = ENDPOINT + "/all-resource-list?page=" + page;
    if(fixed_team) {
