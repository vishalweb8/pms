...
<div class="row">
    <div class="col-xl-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">All Teams</h4>
        </div>
    </div>
</div>
<div class="row">
        ...
        <div class="card emp-list-section ">
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <input type="hidden" value="totalTeamsPage" id="checkPage">
                    <table class="table table-centered  mb-0" id="projectFilterDiv">
                        <thead>
                            <tr>
                                <th class="p-1 bg-white select-project-team">
                                    <input type="text" placeholder="Search Team..." id="teamName" class="form-control border-0" />
                                </th>
                                <th>Employees</th>
                            </tr>
                        </thead>
                        <tbody id="allTeam"></tbody>
                    </table>
                </div>
                <!-- Data Loader -->
...
<script type="text/javascript">
    var ENDPOINT = "{{ url('/') }}";
    var page = 1;
    var siteUrl = ENDPOINT + "/admin-all-team?page=" + page;
    listAjaxCall(siteUrl, "allTeam");
</script>
@endpush
