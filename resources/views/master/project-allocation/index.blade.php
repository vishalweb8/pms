@extends($theme)
@section('breadcrumbs')
{{ Breadcrumbs::render('project-allocation') }}
@endsection
@section('content')
...
<div class="row">
    <div class="col-lg-12">
        ...
        Helper::hasAnyPermission(['allocation.create']) ? route('allocation.create') : '' ])
        <div class="row">
            <div class="col-12">
                <div class="card">
...
<script>
    $(function() {
        ...
        @if(Helper::hasAnyPermission(['allocation.edit','allocation.destroy']))
