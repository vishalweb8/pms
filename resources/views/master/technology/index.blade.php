@extends($theme)
@section('breadcrumbs')
{{ Breadcrumbs::render('technology') }}
@endsection
@section('content')
<div class="row">
    <div class="col-lg-12">
        @include('common.index-title-with-button', ['title' => Str::title(Str::plural($module_title)), 'add_url' =>
        Helper::hasAnyPermission(['technology.create']) ? route('technology.create') : '' ])
        <div class="row">
            <div class="col-12">
                <div class="card">
...
<script>
    jQuery(function() {
        ...
        @if(Helper::hasAnyPermission(['technology.edit','technology.destroy']))
