...
<div class="row">
    <div class="col-lg-12">
        ...
        Helper::hasAnyPermission(['project-status.create']) ? route('project-status.create') : '' ])
        <div class="row">
            <div class="col-12">
                <div class="card">
...
<script>
    $(function() {
        datatalbe = $('#indexDataTable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route("project-status.index") }}',
            columns: [
        ...
        @if(Helper::hasAnyPermission(['project-status.edit','project-status.destroy']))
