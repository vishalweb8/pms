@extends($theme)
@section('breadcrumbs')
{{ Breadcrumbs::render('user-designation') }}
@endsection
@section('content')
...
<div class="row">
    <div class="col-lg-12">
        ...
        Helper::hasAnyPermission(['designation.create']) ? route('designation.create') : '' ])
        <div class="row">
            <div class="col-12">
                <div class="card">
...
<script>
    $(function() {
        ...
        @if(Helper::hasAnyPermission(['designation.edit','designation.destroy']))
