@extends($theme)
@section('breadcrumbs')
{{ Breadcrumbs::render('lead-status') }}
@endsection
@section('content')
...
<div class="row">
    <div class="col-lg-12">
        ...
        Helper::hasAnyPermission(['lead-status.create']) ? route('lead-status.create') : '' ])
        <div class="row">
            <div class="col-12">
                <div class="card">
...
<script>
    $(function() {
        ...
        @if(Helper::hasAnyPermission(['lead-status.edit','lead-status.destroy']))
