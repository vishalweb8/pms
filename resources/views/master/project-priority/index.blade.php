@extends($theme)
@section('breadcrumbs')
{{ Breadcrumbs::render('project-priorities') }}
@endsection
@section('content')
...
<div class="row">
    <div class="col-lg-12">
        ...
        Helper::hasAnyPermission(['project-priority.create']) ? route('project-priority.create') : '' ])
        <div class="row">
            <div class="col-12">
                <div class="card">
...
<script>
    $(function() {
        datatalbe = $('#indexDataTable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route("project-priority.index") }}',
            columns: [
        ...
        @if(Helper::hasAnyPermission(['project-priority.edit','project-priority.destroy']))
