@extends($theme)
@section('breadcrumbs')
{{ Breadcrumbs::render('project-payment-type') }}
@endsection
@section('content')
...
<div class="row">
    <div class="col-lg-12">
        ...
        Helper::hasAnyPermission(['project-payment.create']) ? route('project-payment.create') : '' ])
        <div class="row">
            <div class="col-12">
                <div class="card">
...
<script>
    $(function() {
        datatalbe = $('#indexDataTable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route("project-payment.index") }}',
            columns: [
        ...
        @if(Helper::hasAnyPermission(['project-payment.edit','project-payment.destroy']))
