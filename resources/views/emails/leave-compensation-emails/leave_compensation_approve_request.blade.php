    ...
    <td>
        <table class="section" border="0" cellpadding="0" cellspacing="0" align="center" width="100%" style="background:#ffffff;">
            ...
            <!--leave--approve--content-->
                ...
                <tr>
                    <td>
                        <h2 style="text-align: center; color: #374A5E;">Leave Compensation Request Approved</h2>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <p style="padding: 0px 20px; font-size: 14px; color: #707070; line-height: 25px; padding-bottom: 10px;"> Your leave compensation request has been Approved. </p>
