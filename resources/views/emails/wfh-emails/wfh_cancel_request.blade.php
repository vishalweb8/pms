...
<tr>
    <td>
        <h2 style="text-align: center; color: #374A5E;">Work From Home Cancelled</h2>
    </td>
</tr>
<tr>
    <td>
        ...
        <p style="padding: 0px 20px; font-size: 14px; color: #707070; line-height: 25px; padding-bottom: 10px;">
                            Your work from home request cancelled by {{ Auth::user()->full_name ? ucwords(Auth::user()->full_name) : '-' }}. </p>
        <p style="padding: 0px 20px; font-size: 14px; color: #707070; line-height: 25px; padding-bottom: 10px;">
