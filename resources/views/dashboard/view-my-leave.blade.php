<div class="modal-header">
    <h5 class="modal-title" id="holidayModal">My Leave Info</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<div class="modal-body">
    @if(sizeof($leaves) || !empty($userLeaves))
    <div class="card mb-2">
        <div class="row">
            <div class="col-lg-4">
                <div class="media p-2">
                ...
                <div class="text-lg-center mt-2 mt-lg-0 p-2 p-lg-0">
                    <div class="row">
                        <div class="col-4">
                            <div>
                                <h5 class="mb-0">
                                    {{ number_format((!empty($userLeaves->total_leave) ? $userLeaves->total_leave : Config::get('constant.total_leave')),1) }}
                                </h5>
                        ...
                        <div class="col-4">
                            <div>
                                <h5 class="mb-0">
                                    {{ number_format(Helper::usedLeaves(\Auth::user()->id)->total_duration ? Helper::usedLeaves(\Auth::user()->id)->total_duration : '0', 1) }}
                                </h5>
                        ...
                        <div class="col-4">
                            <div>
                                <h5 class="mb-0">
                                    {{ number_format(number_format((!empty($userLeaves->total_leave) ? $userLeaves->total_leave : Config::get('constant.total_leave')),1) - number_format(Helper::usedLeaves(\Auth::user()->id)->total_duration ? Helper::usedLeaves(\Auth::user()->id)->total_duration : '0', 1),1) }}
                                </h5>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="text-truncate">
                            <p class="fw-medium mb-2 font-size-14">
                                ...
                                <span
                                    class="text-primary">{{ Carbon\Carbon::parse($list->start_date)->format('d M y') }}</span>
                                to
                                <span
                                    class="text-primary">{{ Carbon\Carbon::parse($list->end_date)->format('d M y') }}</span>
                                ({{ $list->duration }})
                            </p>
